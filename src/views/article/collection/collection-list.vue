<template>
  ...
  <div v-loading="loading">
    ...
    >
      <el-table-column prop="collectionId" label="#" width="80" align="center" />
      <el-table-column prop="userId" label="用户id" align="center" width="200" />
      <el-table-column prop="articleTitle" label="文章标题" align="center" width="250" show-overflow-tooltip />
