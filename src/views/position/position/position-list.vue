  ...
  <div v-loading="loading">
    ...
    >
      <el-table-column
        ...
        width="45"
      />
      <el-table-column prop="positionId" label="#" width="60" align="center"/>
      <el-table-column prop="positionName" label="职位名称" width="150" align="center"/>
      <el-table-column prop="positionStatus" label="状态" width="100" align="center">
        <template slot-scope="scope">
          <el-tag v-if="scope.row.positionStatus === 1">启用</el-tag>
          <el-tag v-else type="info">弃用</el-tag>
        </template>
      </el-table-column>
      <el-table-column label="操作" width="360" align="center">
        <template slot-scope="scope">
          <el-button v-if="scope.row.positionStatus === 0" size="mini" type="success" @click="toEnable(scope.row.positionId)">启用
          </el-button>
